  ...
  <div class="demo-page">
    <div class="demo-card">
      <div class="demo-brand">
        <svg viewBox="0 0 24 24" width="30" height="30" fill="none" stroke="#3b7cff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M12 3l7 3v5c0 4.5-3 8.2-7 10-4-1.8-7-5.5-7-10V6l7-3z" />
          <path d="M9 12l2 2 4-4" />
        </svg>
        <h1>行为验证 · 原型</h1>
      </div>
      <p class="demo-subtitle">模仿极验第四代自适应验证码的 Vue 3 交互原型</p>
    ...
    <p class="demo-footer">纯前端交互原型 · 不含真实风控能力 · 仅供演示参考</p>
...
function openRandom() {
  open(Math.random() < 0.5 ? 'slider' : 'click')
}
...
// 支持通过 URL 参数直接打开指定验证方式，便于演示与截图：
// ?captcha=slider | click | random，滑块可追加 &shape=classic|leaf|triangle|circle|diamond|star|heart
onMounted(() => {

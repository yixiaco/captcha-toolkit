...
/**
 * 滑动曲线行为校验器测试：拖拽事件序列与“轨迹终点-答案位移”一致性。
 */
class SlideCurveBehaviorValidatorTest {

    /** 开启行为校验的校验器 */
    private static SlideCurveBehaviorValidator enabledValidator() {
    ...
    private static CaptchaSession session() {
        return CaptchaSession.slideCurve("slide-curve-behavior", 340, 190, 160, 300_000L);
    }
